...
<div style="background-color: #f4f4f4; padding-left: 20px; border-bottom: 2px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 10px;">
    ...
    <a href="/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary">2.5</a>, 2.51, 
...
A connection profile is used by the Fabric Client SDKs to connect to the network. A connection profile can be downloaded from the [Organizations tile](/docs/blockchain-sw-251?topic=blockchain-sw-251-ibp-console-organizations#ibp-console-organizations-connx-profile).
