...
* [Deploy the webhook and custom resource definitions (CRDs) to your OpenShift cluster](/docs/blockchain-sw-251?topic=blockchain-sw-251-deploy-ocp#deploy-k8s-webhook-crd)
