...
- If you have already deployed the operator and do not need HSM, you can skip ahead to [Deploy the {{site.data.keyword.blockchainfull_notm}} Platform console](#deploy-ocp-console-fw).
- If you are using an HSM with the deprecated PKCS #11 proxy to communicate with your HSM, you need to following these [instructions](#deploy-ocp-operator-fw) instead to deploy your operator.
