...
If any of your smart contracts are written in Golang, its shim must be re-vendored before it can be used with the new lifecycle. For more information, check out [Vendoring smart contracts](/docs/blockchain-sw-251?topic=blockchain-sw-251-ibp-console-smart-contracts#ibp-console-smart-contracts-write-package-vendor){: external}.
{: important}
