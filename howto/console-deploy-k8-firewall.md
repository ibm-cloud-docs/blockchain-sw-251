...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: ibp-operator
          image: <LOCAL_REGISTRY>/ibp-operator:2.5.1-20201030-amd64
          command:
          - ibp-operator
          imagePullPolicy: Always
          securityContext:
