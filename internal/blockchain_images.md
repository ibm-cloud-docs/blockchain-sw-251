...
```
docker pull cp.icr.io/cp/ibp-operator:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-init:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-console:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-grpcweb:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-deployer:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-fluentd:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-couchdb:2.3.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-couchdb:3.1.0-20201030-amd64
docker pull cp.icr.io/cp/ibp-peer:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-orderer:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-ca:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-dind:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-utilities:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-peer:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-orderer:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-chaincode-launcher:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-utilities:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-ccenv:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-goenv:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-nodeenv:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-javaenv:2.2.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-crdwebhook:2.5.1-20201030-amd64
docker pull cp.icr.io/cp/ibp-ccenv:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-goenv:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-nodeenv:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-javaenv:1.4.9-20201030-amd64
docker pull cp.icr.io/cp/ibp-enroller:2.5.1-20201030-amd64
```
{:codeblock}
...
3. If you are deploying a peer node, you need to use the core chaincode variables to instruct the peer to build chaincode using the {{site.data.keyword.blockchainfull_notm}} certified images. For example, if you are using Go chaincode, you need to set the following variables:
  ```
  CORE_CHAINCODE_NODE_RUNTIME=cp.icr.io/cp/ibp-nodeenv:1.4.9-20201030-amd64
...
services:
  peer-base:
    image: cp.icr.io/cp/ibp-peer:1.4.9-20201030-amd64
    environment:
      - LICENSE=accept
      - FABRIC_CFG_PATH=/etc/hyperledger/fabric
      - CORE_CHAINCODE_BUILDER=cp.icr.io/cp/ibp-ccenv:1.4.9-20201030-amd64
      - CORE_CHAINCODE_GOLANG_RUNTIME=cp.icr.io/cp/ibp-goenv:1.4.9-20201030-amd64
      - CORE_CHAINCODE_NODE_RUNTIME=cp.icr.io/cp/ibp-nodeenv:1.4.9-20201030-amd64
      - CORE_CHAINCODE_GOLANG_DYNAMICLINK=true
...
services:
  ...
  ca-org1:
    image: cp.icr.io/cp/ibp-ca:1.4.9-20201030-amd64
    environment:
      - LICENSE=accept
...
5. Change back into the main directory of the BYFN example and save the following Docker Compose file for the gRPC web proxy image as `docker-compose-proxy`:
  ...
  services:
    web_proxy.peer0.org1.example.com:
      ...
      image: cp.icr.io/cp/ibp-grpcweb:2.5.1-20201030-amd64
      environment:
        - LICENSE=accept
